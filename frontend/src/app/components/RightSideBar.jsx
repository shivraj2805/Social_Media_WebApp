...
const RightSideBar = () => {
  ...
  return (
    <motion.aside
      ...
      className="h-screen space-y-4"
    >
      <Card className="h-full flex flex-col pb-20">
        <CardHeader>
              ...
              >
                ...
                <div className="flex-1 text-center">
                  ...
                  <a
                    ...
                    className="text-primary text-sm flex items-center justify-center mt-1 hover:underline"
                  >
