...
const Page = () => {
  ...
  const registerSchema = yup.object().shape({
    ...
    password: yup
      .string()
      .min(6, "Password must be at least 6 charchters ")
 ...
 const handleGoogleLogin = () =>{
  ...
  return (
    <div className="min-h-screen bg-gradient-to-tr from-blue-400 to-purple-500 flex items-center justify-center p-20">
      <motion.div
